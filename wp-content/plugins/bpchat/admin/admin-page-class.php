    ...
    public function DisplayPage() {
      ...
      if ($this->saved_flag){
        ...
        if (is_array($this->errors) && count($this->errors) > 0 ){
          ...
          echo '<div class="alert alert-success"><button data-dismiss="alert" class="close" type="button">×</button><strong>'.__('Settings saved.','apc').'</strong> www.FREEWPPREMIUM.com</div>'."\n";
        }
        echo '</div>'."\n";
      }
