	...
	Redux::setSection( $opt_name, array(
		...
		'fields' => array(
			...
			array(  
				...
				'type' => 'button_set',
				'options'   => array(
					'gp-responsive' => esc_html__( 'Enabled', 'socialize' ),
					'gp-fixed' => esc_html__( 'Disabled', 'socialize' ),
				), 
	...
	Redux::setSection( $opt_name, array(
		...
		'fields' => array(								 
			...
			array(
				...
				'type' => 'dimensions',
				'units' => false,
				'title' => esc_html__('Desktop Scrolling Header Height', 'socialize' ) . ' <span class="gp-new-option">New</span>',
			...
			array( 
				...
				'title' => esc_html__( 'Desktop Scrolling Logo', 'socialize' ) . ' <span class="gp-new-option">New</span>',			
				'type' => 'media',
			...
			array(
				...
				'type' => 'dimensions',
				'units' => false,
				'title' => esc_html__('Desktop Scrolling Logo Dimensions', 'socialize' ) . ' <span class="gp-new-option">New</span>',
				'desc' => esc_html__( 'The width and height of the logo on larger devices.', 'socialize' ),
				'subtitle' => esc_html__('Set to half the original logo dimensions for retina displays.', 'socialize' ),
				'default'           => array(
					'width'     => 132, 
		...
		'fields'    => array(
			...
			array(
			 ...
			 array(
				...
				'output'    => array(
					'background-color' => '.widget, .gp-vc-element, .widgettitle.gp-fancy-title .gp-widget-title, .widgettitle.gp-fancy-title .gp-element-icon',
