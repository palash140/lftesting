		...
		<li <?php bp_group_class(); ?>>
			...
			<div class="gp-group-box">
				...
				<div class="item">
					...
					<div class="item-meta"><span class="activity"><?php printf( __( 'active %s', 'socialize' ), bp_get_group_last_active() ); ?></span></div>
...
<?php else: ?>
	...
	<div id="message" class="info">
		<p><?php _e( 'There were no groups found.', 'socialize' ); ?></p>
	</div>
